...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { details: @coupon.details, tenant_id: @coupon.tenant_id, title: @coupon.title }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { details: @coupon.details, tenant_id: @coupon.tenant_id, title: @coupon.title }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
